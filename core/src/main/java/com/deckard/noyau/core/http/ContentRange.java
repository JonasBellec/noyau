...
public class ContentRange {
	...
	/**
	 * Construit le header Content-range � partir des valeurs borneInferieure, borneSuperieure et total
	 * 
	 * @return
	 */
	...
	/**
	 * Construit le header Accepted-Range � partir de la valeur acceptedRange
	 * 
	 * @return
	 */
	...
	public void valoriserTotalAvecImpactSurBornes(long total) {
		...
		// Attention cette m�thode a �t� �crite en partant du principe que les deux bornes ont d�j� modifi� (ou pas) en
		// fonction de l'acceptedRange (voir constructeur)
		// Si on d�place cette m�thode dans le builder, il faut r�fl�chir aux impacts
		this.total = total;
